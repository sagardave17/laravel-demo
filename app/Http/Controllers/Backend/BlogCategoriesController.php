...
class BlogCategoriesController extends Controller
{
    ...
    public function store(StoreBlogCategoriesRequest $request)
    {
        ...
        return redirect()->route('admin.blogcategories.index')
                         ->withFlashSuccess(trans('alerts.backend.blogcategories.created'));
    }
    ...
    public function update(BlogCategory $blogcategory, UpdateBlogCategoriesRequest $request)
    {
        ...
        return redirect()->route('admin.blogcategories.index')
                         ->withFlashSuccess(trans('alerts.backend.blogcategories.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.blogcategories.index')
                         ->withFlashSuccess(trans('alerts.backend.blogcategories.deleted'));
    }
}
